...
joint_all = []
tr_hdf5_path = os.path.join(dataset_dir, "train_dataset_2017.h5")
val_hdf5_path = os.path.join(dataset_dir, "val_dataset_2017.h5")

val_size = 2500 # size of validation set
